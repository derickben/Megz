            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.submitRegistration}>
                <div className="form-group">
                  ...
                  name="name" value={this.state.name} onChange={this.enteredValue}/>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  value={this.state.password} onChange={this.enteredValue}/>
                </div>
                <div className="form-group">
                  <input type="password" className="form-control form-control-lg" placeholder="Confirm Password" 
                  name="password2" value={this.state.password2} onChange={this.enteredValue}/>
                </div>
